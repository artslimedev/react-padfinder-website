...
import House1 from '../../assets/mansion1.jpg'
import Bed1 from '../../assets/bed1.jpg'
import Bed2 from '../../assets/bed2.jpg'
import Kitchen from '../../assets/kitchen.jpg'
import Bathroom from '../../assets/bath1.jpg'

import House2 from '../../assets/mansion2.jpg'
...
const Featured = () => {
  return (
    <div className='featured'>
        ...
        <p className='featured-text'>Seletected listings by City, State, & Zip based on views.</p>
            ...
            <div className="span-3 img-details">
                ...
                <div className="info-grid">
                    ...
                    <div>
                        ...
                        <div className="info">
                            <p className="bold">Est Payment:</p><p>7$14,797/mo</p>
                        </div>
                    </div>
                </div>
            </div>
